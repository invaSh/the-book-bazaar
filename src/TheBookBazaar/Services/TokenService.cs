...
namespace TheBookBazaar.Services
{
    public class TokenService
    {
        ...
        public TokenService(AuthDataContext context, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
            _context = context;
        ...
        public async Task<AuthResponse> GenerateTokens(AppUser user)
        {
