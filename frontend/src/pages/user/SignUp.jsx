...
import { Mail, Lock, Eye, EyeOff, BookOpen, User, AlignCenter } from 'lucide-react';
...
function SignUpPage() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.success('Account created successfully! Welcome to The Book Bazaar!');
      navigate('/');
    } catch (e) {
      console.error(e);
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-creamParchment px-4 sm:px-6 py-10 sm:py-16">
      <div className="w-full max-w-4xl rounded-lg flex justify-center">
            ...
            >
              ...
              <div className="flex text-center">
                <button
                  ...
                  type="submit"
                >
                  {isSubmitting ? 'Creating account...' : 'Join The Bazaar'}
                </button>
              </div>
            </form>
